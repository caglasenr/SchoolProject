import 'package:edirne_gezgini_ui/bloc/register_bloc.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        ...
        child: BlocListener<RegisterBloc, dynamic>(
          listener: (context, state) {
            // Burada Bloc'un yayınladığı durumlar dinlenebilir
          },
          child: Column(
            children: [
              const SizedBox(
  ...
  Widget buildSignUpButton() {
    return BlocBuilder<RegisterBloc, dynamic>(
      builder: (context, state) {
        return TextButton(
          onPressed: () {
            _registerBloc.add(RegisterEvent.registerButtonPressed);
          },
          style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all(Colors.white70),
            padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
